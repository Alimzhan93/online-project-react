...
const Header = ({ selectedPage, setSelectedPage, isTopOfPage }: Props) => {
    const flexBetween = 'flex itens-center justify-between';
    const isAboveMediumScreens = useMediaQuery('(min-width: 1060px)');
    const [isMenuToggled, setIsMenuToggled] = useState(false);
    const backGroundColor = isTopOfPage ? '' : 'bg-primary-100 drop-shadow';

    return (
        <nav>
            <div className={`${backGroundColor}${flexBetween} fixed top-0 z-30 w-full py-6`}>
